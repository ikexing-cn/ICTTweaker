package dev.ikx.rt.impl.internal.clazz;

import dev.ikx.rt.impl.internal.clazz.mods.astralsorcery.ASMTileAttunementAltar;
import dev.ikx.rt.impl.internal.clazz.mods.tconstruct.ASMAbstractMaterialSectionTransformer;
import dev.ikx.rt.impl.internal.clazz.vanilla.ASMItemStack;
...
public class RandomTweakerClassTransformer implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        if (transformedName.startsWith("dev.ikx.rt"))
            return basicClass;
